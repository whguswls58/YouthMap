...
<div class="admin-dashboard-container">
    ...
    <div class="admin-main-content">
        <h2 class="admin-section-title">공지사항 작성</h2>
        
        <div class="write-form">
            <form action="${pageContext.request.contextPath}/admin/list/write" method="post">
                <div class="form-group">
                    <label for="boardSubject">제목</label>
                    <input type="text" id="boardSubject" name="boardSubject" required>
                </div>
