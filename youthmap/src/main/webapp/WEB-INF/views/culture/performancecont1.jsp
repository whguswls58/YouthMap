  ...
  <div class="container">
    ...
    <script>
      kakao.maps.load(function() {
        ...
        var  lat = parseFloat("${cul.con_lot}");     // 위도
        var  lng = parseFloat("${cul.con_lat}");     // 경도
...
<div id="reviewFormWrap" style="display:none;">
    <div class="review-form-container" style="max-width: 400px; margin: 20px auto;">
        ...
        <form action="${pageContext.request.contextPath}/performancecont/reviewwrite" 
    ...
    <c:forEach var="rev" items="${reviewlist}">
        <div style="border-bottom:1px solid #eee;padding:16px 0 10px 0;margin-bottom:0;">
            ...
            <div style="text-align:right;margin-top:7px;">
                ...
                <a href="${pageContext.request.contextPath}/performancecont/reviewdelete?review_id2=${rev.review_id2}&con_id=${rev.con_id}" 
            ...
            <div id="reviewEditForm${rev.review_id2}" class="review-edit-form" style="display:none; background:#f8f9fa; border:1px solid #ccc; border-radius:9px; padding:20px; margin-top:10px;">
                <form action="${pageContext.request.contextPath}/performancecont/reviewedit"
                		 method="post" enctype="multipart/form-data">
  ...
  <div style="text-align:center; margin:30px 0;">
    <c:forEach var="i" begin="1" end="${totalpage}">
      <c:choose>
        ...
        <c:otherwise>
          <a href="${pageContext.request.contextPath}/performancecont?con_id=${performancecont.con_id}&page=${i}" 
