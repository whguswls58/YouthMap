  ...
  <div class="containerer">
    ...
    <div class="detail-flex">
     ...
     <div class="back-container">
 		 <a class="back-link" href="#" onclick="href='/eventlist'">
 		   ← 목록으로 돌아가기
 		 </a>
	</div>
			...
			<div class="review-form">
				<c:choose>
					<c:when test="${not empty sessionScope.loginMember}">
						<form action="${pageContext.request.contextPath}/eventcont/reviewwrite" method="post" enctype="multipart/form-data">
						...
						<div class="review-body">
							...
							<c:if test="${not empty sessionScope.loginMember and sessionScope.loginMember.memNo == rev.mem_no}">
								<div class="review-actions">
									...
									<a href="${pageContext.request.contextPath}/eventcont/reviewdelete?review_id2=${rev.review_id2}&con_id=${rev.con_id}" onclick="return confirm('정말 삭제하시겠습니까?');" class="delete-btn">삭제</a>
								</div>
							</c:if>
							<div id="reviewEditForm${rev.review_id2}" class="review-edit-form" style="display: none; background: #f8f9fa; border: 1px solid #ccc; border-radius: 9px; padding: 20px; margin-top: 10px;">
								<form action="${pageContext.request.contextPath}/eventcont/reviewedit" method="post" enctype="multipart/form-data">
		...
		<div style="text-align: center; margin: 30px 0;">
			<c:forEach var="i" begin="1" end="${totalpage}">
				<c:choose>
					...
					<c:otherwise>
						<a href="eventcont?con_id=${eventcont.con_id}&page=${i}"
