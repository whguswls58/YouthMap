...
public class PolicyModel {
	...
	private Date biz_prd_end_ymd;			// 사업 종료일
	...
	private char sprt_scl_lmt_yn;			// 지원 규모 제한 여부 (Y/N)
	private int sprt_scl_cnt;				// 지원 규모 수
	private char sprt_trgt_age_lmt_yn; 		// 지원 대상 연령 제한 여부 (Y/N)
	private int sprt_trgt_min_age;			// 지원 대상 최소 연령
	private int sprt_trgt_max_age;			// 지원 대상 최대 연령
	...
	private int earn_min_amt;				// 소득 최소 금액
	private int earn_max_amt;				// 소득 최대 금액
	private String earn_etc_cn;				// 소득 기타 내용
	private String add_aply_qlfc_cnd_cn;	// 추가 신청 자격 조건 내용
	private int inq_cnt;					// 조회 수
	private Date aply_ymd_strt;				// 신청 시작일
	private Date aply_ymd_end;			 	// 신청 종료일
