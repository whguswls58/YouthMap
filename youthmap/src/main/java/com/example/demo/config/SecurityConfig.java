        ...
        http.formLogin(form -> form
            ...
            .successHandler((req, res, auth) -> {
             ...
             // ✅ 로그인 시간 기록 및 세션 유효 시간 설정 (30분)
                req.getSession().setMaxInactiveInterval(30 * 60); // 1800초
                req.getSession().setAttribute("loginStartTime", System.currentTimeMillis());

                System.out.println("=== 로그인 성공 핸들러 ===");
                System.out.println("세션에 loginStartTime: " + req.getSession().getAttribute("loginStartTime"));
